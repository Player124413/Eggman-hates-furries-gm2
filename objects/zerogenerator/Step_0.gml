var __b__;
__b__ = action_if(firstSand!=-1 && instance_exists(firstSand));
if __b__
{
if (variable_instance_exists(firstSand,"i") && instance_exists(firstSand.i))
{
    firstSand.i.x=correctX;
    firstSand=-1;
}
else if (!variable_instance_exists(firstSand,"i"))
    firstSand=-1;
}
