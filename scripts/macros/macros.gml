function macros() {
#macro mono_2 @"
	        When the dust has settled the Chaos Emeralds are nowhere to be found.# #
	        Ambitious alchemists have tried to understand them for thousands of years, yet to no avail.# #
	        But, with recent developments in science and technology, one man is closer to this goal than any one before him...
	        "
#macro mono_1 @"
	        It lies in their nature that a great struggle takes place whenever they are gathered.# #
